      ...
      <div className="grid-cols-details">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div className="card" style={{ borderLeft: '4px solid var(--color-secondary)' }}>
            <h3 className="card-title">
              <span style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <RotateCcw size={20} className={isSyncing ? 'scan-glow' : ''} style={{ animation: isSyncing ? 'spin 2s linear infinite' : 'none' }} />
                Synchronisation Google Sheets ➜ App
              </span>
            </h3>
            
            <p style={{ fontSize: '13px', color: 'var(--color-dark-light)', marginBottom: '16px' }}>
              Importez instantanément vos 9 tables de données en direct depuis votre Google Sheets partagé. 
            </p>
            ...
            <button 
              ...
              style={{ width: '100%' }}
              disabled={isSyncing || !googleSheetId}
            ...
            >
              {isSyncing ? (
                ...
                '🔄 Importer en direct depuis Google Sheets'
              )}
            </button>
          </div>
